...
<?php else : ?>
<div id="logout-link">
<?php bp_loggedin_user_avatar( 'width=50&height=50' ) ?> &nbsp; <?php _e("Welcome back",TEMPLATE_DOMAIN); ?>, <?php bp_loggedinuser_link() ?><br /><br />&nbsp;<span class="loglink"><?php bp_log_out_link() ?></span>
